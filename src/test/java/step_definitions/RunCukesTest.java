...
@ExtendedCucumberOptions(jsonReport = "target/cucumber.json",
		...
		usageReport = true,
		toPDF = true,
		includeCoverageTags = {"@LoginNegative,@LoginPositive,@NavigateToPruBuddy,@PruBuddyChat,@LogoutPrutopia"},
...
@CucumberOptions(
		...
		//tags = {"@LoginNegative,@LoginPositive,@NavigateToPruBuddy,@PruBuddyChat,@LogoutPrutopia"}
		tags = {"@LoginPositive,@NavigateToPruBuddy,@PruBuddyChat,@LogoutPrutopia"}
		//monochrome = true
		)
